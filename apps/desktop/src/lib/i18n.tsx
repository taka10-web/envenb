...
const en = {
  ...
  "vars.import.hint": "Nothing is stored until you confirm. Each entry gets a suggested kind; entries marked review need your decision.",
  "vars.import.preview": "Preview",
  "vars.import.confirm": "Import {count} variables",
  "vars.import.invalidLines": "Lines skipped as invalid: {lines}",
  "vars.import.nothing": "No variables found in the pasted text.",
  "vars.import.suggestion": "Suggestion",
...
const ja: Record<keyof typeof en, string> = {
  ...
  "vars.import.hint": "確定するまで何も保存されません。各行に種別の提案が付きます。review と表示された行はご自身で判断してください。",
  "vars.import.preview": "プレビュー",
  "vars.import.confirm": "{count} 件の変数を取り込む",
  "vars.import.invalidLines": "不正な行としてスキップ: {lines} 行目",
  "vars.import.nothing": "貼り付けたテキストに変数が見つかりませんでした。",
  "vars.import.suggestion": "提案",
  "vars.import.review": "review",
